...
public class ReservaVueloEntity {
	...
	public void addPasajero( ReservaVueloPasajeroEntity pasajero ) {
		if ( pasajeros == null ) {
	...
	public List<ReservaVueloPasajeroEntity> getPasajeros() {
		return pasajeros;
	}

	public void setPasajeros( List<ReservaVueloPasajeroEntity> pasajeros ) {
